...
public abstract class DateUtils extends org.apache.commons.lang.time.DateUtils {
	...
	/**
	 * 按指定的格式格式化日期, 默认格式: {@see Format.DATE}.
	 *
	 * @param date
	 * @param pattern
	 * @return string
	...
	/**
	 * 日期型字符串转化为日期, 默认格式: {@see Format.DATE}.
	 *
	 * @param str
	 * @param pattern
	 * @return date
	...
	/**
	 * 字符日期转换成格式为：{@see Format.DATETIME}的日期.
	 *
	 * @param str
	 * @return data
	 */
